...
{
    // using generic LinkedListNode class from System collection
    private readonly Dictionary<int, LinkedListNode<(int key, int value)>> _dict = [];
    private readonly LinkedList<(int key, int value)> _values = new();
    ...
    public void Put(int key, int value)
    {
        ...
        {
            LinkedListNode<(int key, int value)>? node = _values.Last;
            if (node != null)
            {
